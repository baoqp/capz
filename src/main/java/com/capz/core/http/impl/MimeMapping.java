...
public class MimeMapping {
  ...
  static {
    ...
    m.put("bin", "application/octet-streams");
    m.put("dms", "application/octet-streams");
    m.put("lrf", "application/octet-streams");
    m.put("mar", "application/octet-streams");
    m.put("so", "application/octet-streams");
    m.put("dist", "application/octet-streams");
    m.put("distz", "application/octet-streams");
    m.put("pkg", "application/octet-streams");
    m.put("bpk", "application/octet-streams");
    m.put("dump", "application/octet-streams");
    m.put("elc", "application/octet-streams");
    m.put("deploy", "application/octet-streams");
